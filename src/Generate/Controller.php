...
class Controller extends ClassGenerator
{
    ...
    protected function buildClass()
    {
        return view('brackets/admin-generator::' . $this->view, [
            ...
            'containsPublishedAtColumn' => in_array("published_at",
            ...
            'columnsToQuery' => $this->readColumnsFromTable($this->tableName)->filter(function ($column) {
                if ($this->readColumnsFromTable($this->tableName)->contains('name', 'created_by_admin_user_id')) {
                    ...
                    if ($this->readColumnsFromTable($this->tableName)->contains('name', 'updated_by_admin_user_id')) {
                        ...
                        if ($this->readColumnsFromTable($this->tableName)->contains('name',
                                'created_by_admin_user_id') && $this->readColumnsFromTable($this->tableName)->contains('name',
